...
echo "@ $(date)"
echo
python /exports/lkeb-hpc/syousefi/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/sythesize_code/synthesize_asl_loss/invivo_test_network/test_invivo_ssim.py #--where_to_run Cluster
