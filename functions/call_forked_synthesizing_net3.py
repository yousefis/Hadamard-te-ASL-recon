...
from functions.network.forked_densenet3 import _forked_densenet3
...
# --------------------------------------------------------------------------------------------------------
class forked_synthesizing_net3:
    ...
    def run_net(self):
        ...
        forked_densenet=_forked_densenet3()
