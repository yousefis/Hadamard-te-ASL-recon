...
class _densenet2:
    ...
    def densenet(self, img_row1, img_row2, img_row3, img_row4, img_row5, img_row6, img_row7, img_row8, input_dim, is_training):
        ...
        #== == == == == == == == == == == == == == == == == == == == == ==
        #level 1 of unet
        [level_ds1, crop1] = self.level_design(stack_concat, 'synth_level_ds1', filters1=8, filters2=16,
                                               is_training=is_training, kernel_size=3, in_size=in_size3,
                                               crop_size=crop_size2,
                                               padding1='same',padding2='same')

        level_ds1=self.paddingfree_conv( input=level_ds1, filters=8, kernel_size=3, is_training=is_training)

        pool1 = tf.layers.max_pooling3d(inputs=level_ds1, pool_size=(2, 2, 2), strides=(2, 2, 2))
        # level 2 of unet
        [level_ds2, crop2] = self.level_design(pool1, 'synth_level_ds2', filters1=25, filters2=32,
                                               is_training=is_training, kernel_size=3, in_size=in_size4,
                                               crop_size=crop_size1,
                                               padding1='same', padding2='same')
        level_ds2 = self.paddingfree_conv(input=level_ds2, filters=32, kernel_size=3, is_training=is_training)

        pool2 = tf.layers.max_pooling3d(inputs=level_ds2, pool_size=(2, 2, 2), strides=(2, 2, 2))

        # level 3 of unet
        [level_us1, crop0] = self.level_design(pool2, 'synth_level_us1', filters1=32, filters2=40,
                                               is_training=is_training, kernel_size=3, in_size=in_size0,
                                               crop_size=crop_size0,
                                               padding1='same', padding2='same')
        level_us1 = self.paddingfree_conv(input=level_us1, filters=40, kernel_size=3, is_training=is_training)
        ...
        # level 2 of unet
        [level_us2, crop0] = self.level_design(conc12, 'synth_level_us2', filters1=45, filters2=32,
                                               is_training=is_training, kernel_size=3, in_size=in_size0,
                                               crop_size=crop_size0,
                                               padding1='same', padding2='same')

        deconv2 = self.upsampling3d.upsampling3d(level_us2, 'scope2')
        # (level_us1, 'scope1')self.conv3d_transpose(level_us2,
        #                                 filters=40,
        #                                 kernel_size=[3, 3, 3],
        #                                 padding='valid',
        #                                 bn_training=is_training,
        #                                 strides=(2, 2, 2),
        #                                 scope='conv3d_transpose2',
        #                                 activation='ReLu',
        #                                 use_bias=False,
        #                                 initializer=None,
        #                                 trainable=True)
        ...
        # level 1 of unet
        [level_us3, crop0] = self.level_design(conc23, 'synth_level_us3', filters1=25, filters2=32,
        ...
        with tf.name_scope('synth_classification_layer'):
