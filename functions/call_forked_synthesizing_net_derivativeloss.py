...
class forked_synthesizing_net:
    ...
    def run_net(self):
        ...
        y=forked_densenet.densenet( img_row1=img_row1, img_row2=img_row2, img_row3=img_row3, img_row4=img_row4, img_row5=img_row5,
        ...
        with tf.name_scope('averaged_mean_squared_error'):
            [averaged_derivative_huber, derivative_loss,derivative_loss] = self.loss_instance.averaged_derivative_huber(label1=label1,
                                                                 label2=label2,
                                                                 label3=label3,
                                                                 label4=label4,
                                                                 label5=label5,
            ...
            cost = tf.reduce_mean(averaged_derivative_huber, name="cost")
        ...
        tf.summary.scalar("Loss_averaged_derivative_huber", ave_huber_valii)
