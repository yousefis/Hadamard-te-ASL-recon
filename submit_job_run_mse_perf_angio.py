...
def submit_job():
    ...
    main_script = 'run_mse_perf_angio.py'
    ...
    job_name = 'Synth_MSE'+str(backup_number)
...
def backup_script(script_address, main_script, folder_script):
    ...
    backup_root_folder = script_folder + '/CodeCluster_workshop/'
    backup_folder = backup_root_folder + 'backup-mse-' + str(backup_number) + '/'
