...
class _multi_stage_densenet:
    ...
    #==================================================
    def multi_stage_densenet(self, img_row1, img_row2, img_row3, img_row4, img_row5, img_row6, img_row7, img_row8, input_dim, is_training,mri=None,conv_transpose=False):
        mri=None
        ...
        with tf.variable_scope('loss_upsampling1'):
            conv_up1 = tf.layers.conv3d(level_ds3,
                                     filters=14,
                                     kernel_size=3,
                                     padding='same',
                                     activation=None,
            ...
            bn = tf.nn.leaky_relu(bn)
            loss_upsampling1 = self.upsampling3d.upsampling3d(bn,
                                                              ...
                                                              trainable=False,
                                                              padding='valid')
            loss_upsampling11 = self.upsampling3d.upsampling3d(loss_upsampling1,
        ...
        with tf.variable_scope('loss_upsampling2'):
            conv_up2 = tf.layers.conv3d(level_us2,
                                     filters=14,
                                     kernel_size=3,
                                     padding='same',
                                     activation=None,
            ...
            bn = tf.nn.leaky_relu(bn)
            loss_upsampling2 = self.upsampling3d.upsampling3d(bn,
        ...
        return  y,loss_upsampling11,loss_upsampling2
