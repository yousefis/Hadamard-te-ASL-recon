...
def parse_numpy_printoption(kv_str):
 ...
 # ==============================================================================
def return_tensor_value_by_name( tensor_name,file_name):
    reader = pywrap_tensorflow.NewCheckpointReader(file_name)
    try:
        if not tensor_name:
            print(reader.debug_string().decode("utf-8"))
...
def main(unused_argv):
  ...
  file_name = '/srv/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/sythesize_code/Log/synth-12/unet_checkpoints/unet_inter_epoch0_point0.ckpt-0'
  file_name = '/srv/2-lkeb-17-dl01/syousefi/TestCode/EsophagusProject/sythesize_code/Log_perceptual/perceptual-4/unet_checkpoints/unet_inter_epoch0_point9900.ckpt-9900'
  # file_name = '/exports/lkeb-hpc/hsokootioskooyi/Project/DL/RegNet2/TB/3D/20190304_3D_max20_D14_K_NoResp_S4_dec4/train/Model/Saved/RegNet3DModel.ckpt-3840015'
  print_tensors_in_checkpoint_file(file_name, False,
                                     True, False)
  AA=return_tensor_value_by_name('U_upsample1/U_3dUS1/kernel_transposed_3d',file_name )
  print('a')
...
if __name__ == "__main__":
  ...
  # FLAGS.file_name = '/exports/lkeb-hpc/hsokootioskooyi/Project/DL/RegNet2/TB/3D/20190304_3D_max15_D14_K_NoResp_S2_dec4/train/Model/Saved/RegNet3DModel.ckpt-165015'
