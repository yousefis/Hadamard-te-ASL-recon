...
class call_synthesize_net_ssim_angio_perf:
    def __init__(self, data, sample_no, validation_samples, no_sample_per_each_itr,
        ...
        if Server == 'DL':
            ...
            if newdataset == True:
                self.data_path = '/exports/lkeb-hpc/syousefi/Synth_Data/BrainWeb_permutation2_low/' #corrected db
                # self.data_path = '/exports/lkeb-hpc/syousefi/Synth_Data/BrainWeb_permutation01_low/' #corrected db 2 ealier timepoint
            else:
